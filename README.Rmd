...
## Small Example
Although all three functions are available, the main function is create_plot. A short example is illustrated below, which displays the plot as well as estimated treatment effect.
